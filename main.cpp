...
bool InitConfig(int argc, char *argv[])
{
    ...
    descStratum.add_options()
        ...
        ("StratumPort,sp", boost::program_options::value<uint16_t>()->default_value(34414), "Stratum server port")
        ...
        ("RetargetMinDiff", boost::program_options::value<uint32>()->default_value(1750), "Minimum difficulty (also starting difficulty)")
        ("RetargetMaxDiff", boost::program_options::value<uint32>()->default_value(100000), "Maximum difficulty we can reach")
    ;
